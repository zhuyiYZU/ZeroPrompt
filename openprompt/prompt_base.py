...
class Verbalizer(nn.Module):
    ...
    def process_outputs(self,
        ...
        ����һ��OpenPrompt���е�Verbalizer��ķ��������������Ƕ������������д��������ش����Ľ����
        �÷���Ĭ������»ᴦ�������outputs�����������������Ԥѵ������ģ�ͣ�PLM��������logits��
        ��Verbalizer��Ķ����У�process_logits()�������ڽ�logitsת��Ϊ��ǩ�ʣ�label words�������process_outputs()���������process_logits()����������������
        �÷�����������������
        outputs��һ����״Ϊ[batch_size, seq_length, hidden_size]����������ʾԤѵ������ģ�͵��������ͨ������Ԥѵ������ģ�����ɵ�logits��
        batch��һ���ֵ��InputFeaturesʵ������ʾģ���������������������ģ����Ҫ��������Ϣ���������ı�����ǩ����������ȡ�
        ��Verbalizer���У�process_outputs()������Ҫ�����ڽ������outputs�������ݸ�process_logits()����������������������batch�����ݸ�process_logits()�����еĶ�Ӧ������
        ����process_logits()������������ν�logitsת��Ϊ��ǩ�ʣ���˸÷����ķ���ֵͨ����һ����״Ϊ[batch_size, num_labels]����������ʾ��ǩ�ʵķֲ���
